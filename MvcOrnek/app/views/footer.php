    ...
    <script type="text/javascript" src="<?=ASSETS?>tasarım/js/responsee.js"></script>
    <script type="text/javascript" src="<?=ASSETS?>tasarım/js/jquery.events.touch.js"></script>
    <script type="text/javascript" src="<?=ASSETS?>tasarım/owl-carousel/owl.carousel.js"></script>
    <script type="text/javascript" src="<?=ASSETS?>tasarım/js/template-scripts.js"></script>
  </body>
</html>
